    ...
    <nav className='fixed top-0 left-0 right-0 z-50 m-2'>
      <div className='text-neutral-500 bg-black/60 backdrop-blur-md max-w-7xl mx-auto px-4 py-3 flex justify-between items-center rounded-xl border border-neutral-800'>
        ...
        <div className='hidden md:flex space-x-6'>
          <a href="#work" className='hover:text-neutral-200'>How it works</a>
      ...
      {/* MobileView    */}
       {isOpen &&(
        <div className=' md:hidden bg-neutral-900/60 backdrop-blur-md border border-neutral-800 p-4 rounded-full-xl mt-2' >
          ...
          <a href="#" className='hover:text-neutral-200'>Login</a>
          <a href="#" className='border border-neutral-700 text-white py-2 px-4 w-[200px] rounded-lg hover:bg-neutral-700 transition'>Get a Demo</a>
          <a href="#" className='bg-blue-600 text-white py-2 px-4 w-[200px]  rounded-lg hover:bg-blue-500 transition'>Start Free Trial</a>
          </div>
